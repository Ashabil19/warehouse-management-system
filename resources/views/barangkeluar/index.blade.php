        ...
        <tbody>  
            ...
            <tr style="background-color: {{ $index % 2 == 0 ? '#F3F3F3' : '#FFFFFF' }};">  
                ...
                <td style="padding: 8px;">  
                    <span id="resi_{{ $kirim->id }}">{{ $kirim->link_resi }}</span>  
                    <button onclick="openModal({{ $kirim->id }})" class="ml-2 px-2 py-1 bg-blue-500 text-white rounded">Tambah Link Resi</button>  
                </td>  
                <td style="padding: 8px;">  
