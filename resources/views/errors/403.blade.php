...
<body style="height: 100vh; margin: 0; background-color: #292929; display: flex; justify-content: center; align-items: center;">  
    <div style="background-color: #ffffff; border-radius: 10px; padding: 20px 40px; text-align: center; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">  
        ...
        <button onclick="goHome()" style="padding: 10px 20px; background-color: #007bff; color: white; border: none; border-radius: 5px; font-size: 1rem; cursor: pointer; transition: background-color 0.3s;">  
            Kembali  
        </button>  
    </div>  
    ...
    <script>  
        function goHome() {  
            window.location.href = '/'; // Mengarahkan pengguna ke base URL  
        }  
    </script>  
</body>  
</html>  
