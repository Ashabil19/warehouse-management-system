...
@section('title', 'Stock Barang - GudangEasy')    
    
@section('content')    
<h1 style="color: #5B3E99; font-weight: bold; text-align: center;">STOCK BARANG</h1>    
<div style="display:flex; justify-content:space-between; align-items:center">    
    @if(auth()->user()->role == 'purchasing')        
        <a href="{{ route('exports.purchasing') }}" style="display: inline-block; margin-bottom: 20px; padding: 10px 20px; background-color: #5B3E99; color: #FFF; text-decoration: none; border-radius: 5px; font-weight: bold;">Download Stock for Purchasing</a>        
    @elseif(auth()->user()->role == 'logistik')        
        <a href="{{ route('stock.export') }}" style="display: inline-block; margin-bottom: 20px; padding: 10px 20px; background-color: #5B3E99; color: #FFF; text-decoration: none; border-radius: 5px; font-weight: bold;">Download Stock for Logistics</a>        
    @endif        
</div>    
